...
namespace Wibci.MauiControls.Platforms.Android.Utils
{
	...
	public class HtmlTagHandler : Java.Lang.Object, Html.ITagHandler
	{
		...
		public void HandleTag(Boolean opening, String tag, IEditable output, IXMLReader xmlReader)
		{
			if (opening)
			{
				// opening tag
			...
			else
			{
				...
				{
					End(output, typeof(Center), true, new AlignmentSpanStandard(Alignment.AlignCenter));
				}
				else if (tag.EqualsIgnoreCase("s") || tag.EqualsIgnoreCase("strike"))
				{
